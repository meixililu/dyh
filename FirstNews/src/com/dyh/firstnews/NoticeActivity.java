...
import com.dyh.adapter.NoticeListItemAdapter;
...
public class NoticeActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new NoticeListItemAdapter(this,beans);
    ...
    class RequsetDataTask extends AsyncTask<Void, Void, Void> {
    	...
    	protected Void doInBackground(Void... params) {
    		try {
    			...
    			map.put("id", "0");
    			List<NewsBean> resultList = (List<NewsBean>) new DiyihuiHttp().post(NoticeActivity.this,HttpUtil.notice,map,new NewsBeanParser() );
				if(resultList != null){
