...
import com.dyh.firstnews.TopicActivity.RequsetDataTask;
...
public class DiyihuiActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_diyihui);
        ...
        adapter = new NewsListItemAdapter(this,beans);
        listview.setAdapter(adapter);
        
        listview.setOnItemClickListener(new OnItemClickListener() {
        	@Override
        	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        		Intent intent = new Intent(DiyihuiActivity.this,NewsDetailActivity.class);
        		DiyihuiActivity.this.startActivity(intent);
        	}
        });
    ...
    class RequsetDataTask extends AsyncTask<Void, Void, Void> {
    	...
    	protected Void doInBackground(Void... params) {
    		try {
    			...
    			map.put("id", "0");
    			List<NewsBean> resultList = (List<NewsBean>) new DiyihuiHttp().post(DiyihuiActivity.this,HttpUtil.phvalue,map,new NewsBeanParser() );
				if(resultList != null){
